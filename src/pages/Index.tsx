    ...
    <div className="bg-[#0B0B0C] text-white min-h-screen pb-16">
      ...
      <section className="max-w-4xl mx-auto mt-14 px-4 grid sm:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center text-center bg-[#141416] p-6 rounded-2xl shadow-lg">
          <img src="/assets/icons/delivery.png" alt="Fast Delivery" className="w-16 h-16 mb-3" />
        ...
        {/* SUPPORT */}
        <div className="flex flex-col items-center text-center bg-[#141416] p-6 rounded-2xl shadow-lg">
          <img src="/assets/icons/support.png" alt="24/7 Support" className="w-16 h-16 mb-3" />
        ...
        {/* BRANDING */}
        <div className="flex flex-col items-center text-center bg-[#141416] p-6 rounded-2xl shadow-lg">
          <img src="/assets/icons/secure.png" alt="Official Shop" className="w-16 h-16 mb-3" />
